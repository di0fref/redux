...
export default function Trash() {
    ...
    return (
        <Link to={`/trash`} onClick={() => setOpen(!open)} className={`sidebar-item ${(currentFolder.id === "trash") ? "bg-gray-800 text-white" : ""} flex items-center rounded  py-2 w-full px-2 text-menu`}>
