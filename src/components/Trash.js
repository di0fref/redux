...
export default function Trash() {
    ...
    return (
        <Link to={`/folder/trash`} onClick={() => setOpen(!open)} className={`${(currentFolder.id === "trash") ? "bg-gray-800 text-white" : ""} flex items-center rounded hover:bg-gray-800 py-2 w-full px-2 text-menu`}>
