    ...
    return (
        <div className={`flex h-screen bg-white dark:bg-gray-900_`}>
            <div className={`flex ${sidebar ? "ml-0" : "-ml-144"} transition-all absolute md:relative z-10 w-full md:w-auto`}>
                <div className={`${sidebar ? "ml-0" : "md:ml-0 -ml-72"} md:w-72 w-1/2 h-screen overflow-y-auto md:h-full bg-gray-900 dark:bg-gray-900 text-white dark:text-gray-400 flex-shrink-0 `}>
                    <Sidebar/>
                </div>
