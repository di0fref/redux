        ...
        <>
            ...
            >
                <div className=
                    ...
                    <div className={"w-4 h-4 mr-2 text-gray-500"}><FaRegFolder className={"text-yellow-500"}/></div>
...
export default function Sidebar() {
    ...
    useUrl(
        (params) => {
            dispatch(fetchNotesByFolderId(params.folder))
            dispatch(setCurrentFolder(params.folder))
        ...
        <>
            ...
            <div className={"p-2"}>
                <Link to={`/folder/0`} className={`${(currentFolder.id === 0) ? "bg-gray-200" : ""} flex items-center rounded hover:bg-gray-200 py-1 w-full px-2`}>
                    <div><FaUser className={"h-4 w-4 text-gray-500"}/></div>
